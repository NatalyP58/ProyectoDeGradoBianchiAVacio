...
# 3) Sistema expansion hacia De Sitter  (Sistema con H postivo cumple la codcion (a) y (b) de Kitada y Maeda,
...
# 4) Expansion con K=Sqrt[(3*Lambda])]   ,  H=1.0  y Lambda=3
...
#  5) Sistema de caso de expansion en   -Sqrt[(3*Lambda])] <K<Sqrt[(3*Lambda])]
...
h = 0.1
precision=1e-14
T1 ,Y1, constraint1 , q1, Omega_k1= RungeKutta4(y06, a6,b6, h, f, Constraint,Lambda)
T2 ,Y2, constraint2 , q2, Omega_k2= RungeKutta4(y06, a6,b6, h/2.0, f,  Constraint,Lambda)
T3 ,Y3, constraint3 , q3, Omega_k3= RungeKutta4(y06, a6,b6, h/4.0, f, Constraint,Lambda)
...
T4 ,Y4, constraint4 , q4, Omega_k4= RungeKutta4(y06, a6,b6, h, f, Constraint,Lambda)
T5 ,Y5, constraint5 , q5, Omega_k5= RungeKutta4(y06, a6,b6, h/10.0, f,  Constraint,Lambda)
T6 ,Y6, constraint6 , q6, Omega_k6= RungeKutta4(y06, a6,b6, h/100.0, f, Constraint,Lambda)
